...
public class HttpURLResponse {
  ...
  /**
   * The actual response code. Can be any user defined integer (usually defined
   * as integer constants in a class) but is usually a response code defined in
   * HTTPURLConnection.
   */
  ...
  public boolean equals(Object response) {
    ...
    if (result) {
      ...
      result = httpURLResponse.responseCode == responseCode
          ...
          && ((httpURLResponse.responseBody == null && responseBody == null) || (httpURLResponse.responseBody != null
              && responseBody != null && httpURLResponse.responseBody.equals(responseBody)));
    }
    return result;
  }
